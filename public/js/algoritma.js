...
function runBellmanFordDefault() {
  ...
  if (sourceNode == "A" && destination == "F") {
    ...
    const prevDestination = document.getElementById("destination-default").getAttribute("prev-destination");
    if (prevDestination != "F") {
      ...
      document.getElementById("destination-default").setAttribute("prev-destination", "");
  ...
  notifMisiHTML += "</pre>";
  notifMisiElement.innerHTML = notifMisiHTML;
  document.getElementById("destination-default").setAttribute("prev-destination", destination);
}
